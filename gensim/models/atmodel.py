...
class AuthorTopicModel(LdaModel):
    ...
    def __str__(self):
        ...
        """
        return f"{self.__class__.__name__}<num_terms={self.num_terms}, num_topics={self.num_topics}, num_authors={self.num_authors}, decay={self.decay}, chunksize={self.chunksize}>"
